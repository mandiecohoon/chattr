...
@NamedQueries({
    ...
    @NamedQuery(name = "ChattrMessages.findById", query = "SELECT m FROM Message m WHERE m.messageId = :messageId")
})
public class Message implements Serializable {
    ...
    public Message(int messageId, String message, int roomId) {
